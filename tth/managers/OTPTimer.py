...
class OTPTimer(DirectFrame):
    ...
    def __init__(self, useImage = True, highlightNearEnd = True):
        if useImage:
            ...
            image = None
        DirectFrame.__init__(self, state=DGG.DISABLED, relief=None, scale=0.45, image=image, image_pos=(0, 0, 0), text='0', text_fg=(0, 0, 0, 1), text_font="phase_3/models/fonts/ImpressBT.ttf", text_pos=(-0.01, -0.15), text_scale=0.35)

...
class TLGatherAllAvs(DirectObject):
    ...
    def __init__(self, name, *limits):
        ...
        self._avId2limits = {}
        avs = base.cr.doFindAllInstances('DistributedAvatar')
        for av in avs:
            self._handlePlayerArrive(av)

        self.accept('DistributedPlayerGenerateEvent', self._handlePlayerArrive)
        self.accept('DistributedPlayerNetworkDeleteEvent', self._handlePlayerLeave)

...
class FishPhoto(NodePath):
    ...
    def makeFishFrame(self, actor):
        ...
        spc = self.fish.getSpecies()
        fishInfo = FishingGlobals.getFishData(spc,0)[1]
        fishPos = fishInfo[5]
        if fishPos:
    ...
    def show(self, showBackground = 0):
        ...
        #else:
         #   cdr = self.fishDisplayRegion.cDr
         #   cdr.setClearColor((0,0,0,0))
         #   cdr.setClearColorActive(0)

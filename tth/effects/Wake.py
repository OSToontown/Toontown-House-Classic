...
if not getattr(__builtin__,"isServer",False):
    RipplesModel = loader.loadModel('phase_4/models/props/ripples.bam')
    RipplesModel.setName('ripples')
    def getRipplesCopy():
        return RipplesModel.copyTo(hidden)

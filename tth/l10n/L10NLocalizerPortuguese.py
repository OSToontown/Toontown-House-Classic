...
from L10NLocalizerPortugueseCogs import data as CogData
from L10NLocalizerPortugueseSC import data as SpeedChatData
...
Review may\ntake a few days.\nWhile you wait\nyour name will be\n '
CATNameShopContinueSubmission = 'Continue Submission'
CATNameShopChooseAnother = 'Choose Another Name'
CATAllNewNames = 'All new names must be\napproved by a staff member.'
...
FishNames=(
           ('Peixe Palha�o','Peixe Palha�o Triste','Peixe Palha�o de Festa','Peixe Palha�o de Circo'),
           ('Baiacu','Baiacu Bal�o de Ar','Baiacu Bal�o Meteorol�gico','Baiacu bal�o de �gua','Baiacu Bal�o Vermelho'),
           ('Peixe Gato','Peixe Gato Siam�s','Peixe Gato de Rua','Peixe Gato Rajado','Peixe Gato Tonto'),
           ('Raia Jamanta',),
           ('Peixe Congelado',),
           ('Estrela do mar','Cinco Estrelas do mar','Estrela do mar do Rock','Estrela do mar Cintilante','Estrela do mar All Star'),
           ('Cavala Trotante',),
           ('Cachorra','Cachorra Buldogue','Cachorra-quente','Cachorra D�lmata','Cachorrinha'),
           ('Enguia Amore','Enguia Amore El�trica'),
           ('Tubar�o enfermeira','Tubar�o enfermeira Clara','Tubar�o enfermeira Flora'),
           ...
           ('Cavalo Marinho','Cavalo Marinho de Pau','Cavalo Marinho Clydesdale','Cavalo Marinho �rabe'),
           ('Tubar�o Fera','Tubar�ozinho Fera','Tubar�o-Fera da Piscina','Tubar�o-Fera da Piscina Ol�mpica'),
           ...
           ('Truta','Capit�o Truta Cicuta','Truta Cicuta Escorbuta'),
           ('Piano Atum','Grande Piano Atum','Grande Piano Atum Baby','Piano Atum Ereto','M�sico de Piano Atum'),
           ('Manteiga de Amendoim e �gua Viva','Manteiga de Amendoim e �gua Viva de Uva','Manteiga de Amendoim e �gua Viva Crocante','Manteiga de Amendoim e �gua Viva de Morango','Manteiga de Amendoim e �gua Viva'),
           )

FishingTankFull = 'Seu balde est� cheio. Vai vender seus peixes para o Vendedor da Loja de Animais e volte.'
FishingBroke = 'Voc� n�o tem mais balinhas para isca! Jogue no bondinho ou venda seus peixes para o Vendedor da Loja de Animais para conseguir mais balinhas.'
...
FishingExit = 'Exit'
FishingCast = 'Cast'
FishingItemFound = 'Voc� pegou:'
FishingBootItem = 'Uma bota velha'

FishGuiCancel = 'Cancelar'
FishGuiOk = 'Vender tudo'
FishTankValue = 'Ol�, %(name)s! Voc� tem %(num)s peixes em seu balde que valem um total de %(value)s balinhas. Voc� quer vender tudo?'
...
FishermanSaleCancel = "Come back here to sell fish to the Pet Shop for jellybeans."
FishermanSaleDone = "Thanks! The Pet Shop will love these! Bye!"
FishermanSaleBonus = "Wow you got %s out of 70 fish! That deserves a laff boost and a trophy!"
NPCTimeout = "Need more time to think?"
